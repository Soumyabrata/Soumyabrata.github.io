...
|                  |                                                                       |
|------------------|-----------------------------------------------------------------------|
| email            | <a href="mailto:devs@tcd.ie">devs@tcd.ie</a>						   |
| phone            | + 353 1896 1797                                                       |
| address          | Room 0.33, Lloyd Institute, Dublin 2                                  |
| (TCD)            | Trinity College Dublin, Ireland                                       |
|                  | (see <a href="https://maps.app.goo.gl/3uk9HEcSfZyG6CN77">Google Maps</a>)
...
| office hours     | Via <a href="mailto:devs@tcd.ie">email</a> appointment     		   |
